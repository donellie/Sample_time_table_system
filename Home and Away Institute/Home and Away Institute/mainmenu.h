...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(390, 125);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(185, 39);
			...
			this->button1->Location = System::Drawing::Point(436, 220);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(93, 42);
			this->button1->TabIndex = 1;
			this->button1->Text = L"Manage Course";
			...
			this->button2->Location = System::Drawing::Point(436, 300);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(93, 43);
			this->button2->TabIndex = 2;
			this->button2->Text = L"Manage Course Schedule";
			...
			this->button3->Location = System::Drawing::Point(436, 378);
...
private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 coursemenu^ menu = gcnew coursemenu;
			 menu->ShowDialog();	 	    
...
private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 courseschedule^ menu = gcnew courseschedule;
			 menu->ShowDialog();
		 }
};
}
