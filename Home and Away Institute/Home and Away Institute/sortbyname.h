...
namespace HomeandAwayInstitute {
	...
	/// <summary>
	/// Summary for sortbyname
	/// </summary>
	public ref class sortbyname : public System::Windows::Forms::Form
	{
	public:
		sortbyname(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(sortbyname::typeid));
			...
			this->button1->Location = System::Drawing::Point(418, 501);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(89, 34);
			this->button1->TabIndex = 13;
			this->button1->Text = L"Sort";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &sortbyname::button1_Click);
			// 
			// dataGridView1
			// 
			...
			this->Name = L"sortbyname";
			this->Text = L"Home and Away Institute";
			this->Load += gcnew System::EventHandler(this, &sortbyname::sortbyname_Load);
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->dataGridView1))->EndInit();
			this->ResumeLayout(false);

		}
#pragma endregion
	private: System::Void sortbyname_Load(System::Object^  sender, System::EventArgs^  e) {
...
private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 String ^sLine = "";
				...
				try
				{
					...
					System::IO::StreamReader ^FileStream = gcnew System::IO::StreamReader("sortbyname.txt");
