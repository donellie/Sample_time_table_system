...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(641, 513);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(64, 22);
			this->button1->TabIndex = 12;
			this->button1->Text = L"Update";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &updatecourse::button1_Click_1);
			// 
			// dataGridView1
			// 
			...
			this->dataGridView1->Size = System::Drawing::Size(1013, 495);
			...
			this->label1->Location = System::Drawing::Point(234, 516);
			...
			this->button2->Location = System::Drawing::Point(560, 513);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(75, 23);
			this->button2->TabIndex = 19;
			this->button2->Text = L"Search";
			this->button2->UseVisualStyleBackColor = false;
			this->button2->Click += gcnew System::EventHandler(this, &updatecourse::button2_Click);
			// 
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(383, 515);
