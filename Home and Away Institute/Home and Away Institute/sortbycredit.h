...
namespace HomeandAwayInstitute {
	...
	/// <summary>
	/// Summary for sortbycredit
	/// </summary>
	public ref class sortbycredit : public System::Windows::Forms::Form
	{
	public:
		sortbycredit(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(sortbycredit::typeid));
			...
			this->dataGridView1->Size = System::Drawing::Size(1012, 481);
			...
			this->button1->Location = System::Drawing::Point(444, 488);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(81, 32);
			this->button1->TabIndex = 13;
			this->button1->Text = L"Sort";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &sortbycredit::button1_Click);
			// 
			// sortbycredit
			// 
			...
			this->Name = L"sortbycredit";
			this->Text = L"Home and Away Institute";
			this->Load += gcnew System::EventHandler(this, &sortbycredit::sortbycredit_Load);
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->dataGridView1))->EndInit();
			this->ResumeLayout(false);

		}
#pragma endregion
	private: System::Void sortbycredit_Load(System::Object^  sender, System::EventArgs^  e) {
...
private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 String ^sLine = "";
				...
				try
				{
					...
					System::IO::StreamReader ^FileStream = gcnew System::IO::StreamReader("sortbycredit.txt");
